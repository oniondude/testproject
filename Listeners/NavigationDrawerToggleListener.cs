...
namespace SIM
{
	...
	class NavigationDrawerToggleListener : ActionBarDrawerToggle
	{
		public NavigationDrawerToggleListener(Activity activity, DrawerLayout drawerLayout,  int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes)
